...
public class Programme_10_TubeLine_Advanced
{
    ...
    {
        String station [] = ("Algate, Angle, Baker Street, Bank, Barbican, Bayswater, Blackfriars, Bont Street"+
                "Borough,Cannon Street, Chancery Lane, Charning Cross, Covent garden, Earls' Court"+
